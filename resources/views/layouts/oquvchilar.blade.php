	...
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize">O'quvchilar</h2>
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					<li class="list-inline-item"><a href="index.html">Uy</a>
					</li>
					<li class="list-inline-item">/ &nbsp; <a href="how-it-works.html">O'quvchilar</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="row justify-content-between align-items-center">
			...
			<div class="col-lg-6 mt-5 mt-lg-0">
				<div class="has-video-popup position-relative">
					<img loading="lazy" decoding="async" src="{{asset('../build/assets/images/video-thumb.png')}}" alt="video thumb" class="rounded-lg w-100">
	  ...
	  <div class="row position-relative">
		<div class="col-lg-4 col-md-6 pt-1 ">
		  <div class="section-title "><br><br>
			...
			<p class="lead mb-0">KIUT Namangan o'quvchilari tomonidan joylangan yangiliklar </p>
		  </div>
		</div>
		<div class="col-lg-4 col-md-6 pt-1">
